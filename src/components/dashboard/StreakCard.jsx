    ...
    <section className="overflow-hidden rounded-3xl border border-orange-400/20 bg-gradient-to-br from-orange-500/20 via-ab-card to-ab-card p-5 shadow-[0_12px_40px_rgba(255,107,53,0.1)]">
      <div className="flex items-start justify-between">
        <div>
          ...
          <div className="mt-1 flex items-end gap-2"><span className="font-display text-5xl font-bold leading-none text-white">{streak}</span><span className="mb-1 text-sm text-ab-muted">days strong</span></div>
        </div>
